...
class ShoppingListNotifier extends StateNotifier<List<ShoppingItemModel>> {
  ShoppingListNotifier()
      : super([
          ...
          ShoppingItemModel(
              name: '라면', quantity: 5, hasBought: false, isSpicy: false),
          ShoppingItemModel(
              name: '삼겹살', quantity: 1, hasBought: true, isSpicy: true),
          ShoppingItemModel(
              name: '수박', quantity: 4, hasBought: false, isSpicy: false),
          ShoppingItemModel(
              name: '카스테라', quantity: 7, hasBought: true, isSpicy: true),
        ]);
